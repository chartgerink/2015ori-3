...
```{r, echo = FALSE, out.width="40%", fig.align="center",  fig.cap="_Figure 1._ Visual representation of the typical components to a data based plot. This serves as the basis of the software to extract data from the plot body."}
...
```{r, echo=FALSE, out.width='100%', fig.cap="_Figure 2._ Screenshot of the search criteria used to search ScienceOpen."}
...
```{r, echo = FALSE, out.width='100%', fig.cap="_Figure 3._ Example of a funnel plot with selectable axes [reproduced under CC BY-NC license from @10.2147/amep.s116699], but including a bitmap body. This can be seen by the large difference in quality between the body and the axes, where the axes are crisp and the body is pixelated. The x-axis is selected."}
...
```{r, echo=FALSE, out.width='100%', fig.cap="_Figure 4._ The original depiction of a funnel plot [left, reproduced under CC BY license from @10.1186/s13027-016-0058-9] and the manually extracted part that is subsequently ingested into the `norma` software (right)."}
...
Chris HJ Hartgerink is a PhD-candidate in methods and statistics from Tilburg University (NLD) as part of the Meta Research group (www.metaresearch.nl). He is finishing up his final year of the PhD and is a Mozilla Science Fellow (2017).
